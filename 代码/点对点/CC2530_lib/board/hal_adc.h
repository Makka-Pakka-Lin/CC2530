...
/* Resolution */
#define HAL_ADC_RESOLUTION_8       0x01//7位有效位
#define HAL_ADC_RESOLUTION_10      0x02//9位有效位
#define HAL_ADC_RESOLUTION_12      0x03//10位有效位
#define HAL_ADC_RESOLUTION_14      0x04//12位有效位
